...
class DynamicBatchSpanProcessor(WrapperSpanProcessor):
    ...
    processor: BatchSpanProcessor  # type: ignore[reportIncompatibleVariableOverride]
    ...
    def batch_processor(self):
        return self.processor._batch_processor  # type: ignore[reportPrivateUsage]

    @property
    def span_exporter(self) -> SpanExporter:
        return self.batch_processor._exporter  # type: ignore[reportReturnType, reportPrivateUsage]

    @property
    def schedule_delay_millis(self) -> float:
        return self.batch_processor._schedule_delay * 1000  # type: ignore[reportPrivateUsage]

    @schedule_delay_millis.setter
    def schedule_delay_millis(self, value: float):
        self.batch_processor._schedule_delay = value / 1000  # type: ignore[reportPrivateUsage]
