...
def _summarize_db_statement(span: ReadableSpanDict):
    attributes = span['attributes']
    message: str | None = attributes.get(ATTRIBUTES_MESSAGE_KEY)  # type: ignore[reportAssignmentType]
...
def _transform_langchain_message(old_message: dict[str, Any]) -> dict[str, Any]:
    ...
    if isinstance(content, list) and content:  # type: ignore[reportUnnecessaryIsInstance]
