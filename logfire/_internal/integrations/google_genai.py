...
try:
    ...
    original_flatten_compound_value = dict_util._flatten_compound_value  # type: ignore[reportPrivateUsage]
    ...
    dict_util._flatten_compound_value = wrapped_flatten_compound_value  # type: ignore[reportPrivateUsage]
except Exception:  # pragma: no cover
    pass
...
try:
    ...
    original_to_dict: Any = generate_content._to_dict  # type: ignore[reportPrivateUsage]
    ...
    generate_content._to_dict = wrapped_to_dict  # type: ignore[reportPrivateUsage]
...
class SpanEventLogger(Logger):
    ...
    def emit(self, record: LogRecord) -> None:  # type: ignore[reportIncompatibleMethodOverride]
