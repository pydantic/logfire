...
class UnexpectedResponse(RequestException):
    ...
    response: Response  # type: ignore[reportIncompatibleVariableOverride]
...
def get_version(version: str) -> Version:
    ...
    try:
        ...
        try:
            ...
            from setuptools._vendor.packaging.version import Version
    return Version(version)  # type: ignore[reportReturnType]
...
try:
    ...
    SUPPRESS_INSTRUMENTATION_CONTEXT_KEYS.append(context._SUPPRESS_INSTRUMENTATION_KEY)  # type: ignore[reportPrivateUsage]
    ...
    try:
        ...
        if id(exc) in seen:
            ...
            if isinstance(exc, BaseExceptionGroup):
                sub_exceptions: tuple[BaseException] = exc.exceptions  # type: ignore[reportUnknownVariableType, reportUnknownMemberType, reportAssignmentType]
                parts += [
                    '\n<ExceptionGroup>',
