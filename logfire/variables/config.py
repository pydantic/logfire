...
from pydantic import Discriminator, field_validator, model_validator, TypeAdapter
...
class VariablesConfig:
    ...
    def get_validation_errors(self, variables: list[Variable]) -> dict[str, Exception]:
