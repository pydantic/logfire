...
if TYPE_CHECKING:
    from pyarrow import Table  # type: ignore[reportUnknownVariableType]
...
class LogfireQueryClient(_BaseLogfireQueryClient[Client]):
    ...
    def query_arrow(  # type: ignore[reportUnknownParameterType]
        self,
        sql: str,
        min_timestamp: datetime | None = None,
        max_timestamp: datetime | None = None,
        ...
        with pyarrow.ipc.open_stream(response.content) as reader:  # type: ignore[reportUnknownMemberType, reportUnknownVariableType]
            arrow_table: Table = reader.read_all()  # type: ignore[reportUnknownMemberType, reportUnknownVariableType]
        return arrow_table  # type: ignore[reportUnknownVariableType]
...
class AsyncLogfireQueryClient(_BaseLogfireQueryClient[AsyncClient]):
    ...
    async def query_arrow(  # type: ignore[reportUnknownParameterType]
        self,
        sql: str,
        min_timestamp: datetime | None = None,
        max_timestamp: datetime | None = None,
