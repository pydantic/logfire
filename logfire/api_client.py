...
projects, tokens, alerts, dashboards, channels, and variables.
"""
...
class LogfireAPIClient(_BaseLogfireAPIClient[Client]):
    ...
    def get_variable_by_name(self, variable_name: str) -> dict[str, Any]:
        ...
        Returns:
            The variable definition with current variants.
    ...
    def create_variable(self, body: dict[str, Any]) -> dict[str, Any]:
        ...
        Args:
            body: The variable definition to create, including:
                ...
                - variants: Dict mapping variant keys to variant data
                - rollout: Rollout configuration
                - overrides: List of override rules
    ...
    def update_variable(self, variable_name: str, body: dict[str, Any]) -> dict[str, Any]:
        ...
        Args:
            ...
            body: The update data, which may include:
                ...
                - rollout: Updated rollout configuration
                - overrides: Updated override rules
