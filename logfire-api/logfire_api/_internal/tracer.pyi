...
class ProxyTracerProvider(TracerProvider):
    ...
    def __init__(self, *generated_args, provider, config, tracers=..., lock=..., **generated_kwargs) -> None: ...
...
class _MaybeDeterministicTimestampSpan(trace_api.Span, ReadableSpan):
    ...
    def __init__(self, *generated_args, span, ns_timestamp_generator, **generated_kwargs) -> None: ...
...
class _ProxyTracer(Tracer):
    ...
    def __init__(self, *generated_args, tracer, provider, is_span_tracer, **generated_kwargs) -> None: ...
...
class PendingSpanProcessor(SpanProcessor):
    ...
    def __init__(self, *generated_args, id_generator, other_processors, **generated_kwargs) -> None: ...
