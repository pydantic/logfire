...
```text
Set up Pydantic Logfire in this project. Read https://pydantic.dev/docs/logfire/get-started/ and
follow it to install the Logfire SDK, call logfire.configure() at the app's startup, and
...
Or do it by hand. Pick your language below; the Python and JavaScript/TypeScript tabs are complete, runnable examples.
