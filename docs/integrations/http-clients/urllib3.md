...
[`logfire.instrument_urllib3()`][logfire.Logfire.instrument_urllib3] accepts additional keyword
arguments and passes them to the OpenTelemetry urllib3 instrumentation. See
[their documentation][opentelemetry-urllib3] for the full list.
