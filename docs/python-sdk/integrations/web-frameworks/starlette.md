...
You can use experimental proxy handler to securely forward OTLP telemetry through your Starlette backend. See the [Browser Telemetry Proxying guide](https://pydantic.dev/docs/logfire/typescript-sdk/packages/browser/#proxying-browser-telemetry) for detailed instructions.
