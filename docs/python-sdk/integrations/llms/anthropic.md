...
!!! note
    This is separate from [Claude Agent SDK instrumentation](./claude-agent-sdk.md). The Claude Agent SDK doesn't actually use the `anthropic` package under the hood.
