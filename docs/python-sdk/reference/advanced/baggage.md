...
See the [Distributed Tracing](../../instrumentation/distributed-tracing.md#integrations)
...
- **Don't put sensitive information in Baggage**, as it may be sent to third party services. While span attributes from baggage are still [scrubbed](../../instrumentation/scrubbing.md) by default, the Baggage header itself is not scrubbed.
