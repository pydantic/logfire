---
title: "Logfire Python SDK: Getting Started"
description: "Step by Step Guide to Getting Started with the Pydantic Logfire Python SDK: how to set up, install and instrument your first project."
---
...
This page walks through setting up a Python app. For other languages, see the [TypeScript SDK](https://pydantic.dev/docs/logfire/typescript-sdk/) or our [language support](../languages.md) page.
...
- Complete the [Onboarding Checklist](./instrumentation/index.md)
...
- As well as spans, you can [use Logfire to record metrics](./instrumentation/metrics.md)
