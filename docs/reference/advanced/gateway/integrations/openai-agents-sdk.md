...
Send requests from your OpenAI Agents SDK agents through Logfire to track model usage and apply gateway spending limits without changing your handoffs or tools.
