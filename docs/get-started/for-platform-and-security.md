...
4. **[Single sign-on (SSO) setup](../how-to-guides/sso-setup.md)**: let your team sign in through your existing identity provider (Microsoft Entra ID, Okta, or a Keycloak OIDC provider) instead of separate Logfire logins. Available on Enterprise Cloud.
