...
Logfire supports SSO authentication with OIDC (OpenID Connect) Providers, allowing your team to access the platform using their existing corporate credentials. 
