...
| Time to first token panels are empty | Only streaming calls populate these panels. Use Pydantic AI 2.6.0 or later, and widen the dashboard time range to include recent streaming calls. |
