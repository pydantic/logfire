...
- **Frontend + backend debugging:** Use Logfire's  [JavaScript SDK](https://pydantic.dev/docs/logfire/typescript-sdk/?utm_source=sentry_comparison_docs) to trace and debug your entire application
