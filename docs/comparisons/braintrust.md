...
**Logfire** makes all instrumentation easy with first-class [integrations](https://pydantic.dev/docs/logfire/python-sdk/integrations/?utm_source=braintrust_compare_docs):
