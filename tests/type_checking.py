...
# using a list of types produces their union:
my_variable_1 = logfire.Logfire().var(name='my-variable-1', default='a', type=[int, str])
assert_type(my_variable_1, Variable[int | str])
...
my_variable_2 = logfire.Logfire().var(name='my-variable-2', default=None, type=[int, str])
assert_type(my_variable_2, Variable[int | str | None])
