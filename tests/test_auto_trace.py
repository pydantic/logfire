...
def test_auto_trace_sample(exporter: TestExporter) -> None:
    ...
    assert exporter.exported_spans_as_dict(_include_pending_spans=True) == snapshot(
        [
            ...
            {
                'name': 'Calling gen2 via @instrument (pending)',
                ...
                'attributes': {
                    ...
                    'code.lineno': 123,
                    'code.function': 'gen2',
                    'logfire.msg_template': 'Calling gen2 via @instrument',
                    'logfire.span_type': 'pending_span',
                    'logfire.msg': 'Calling gen2 via @instrument',
                    'logfire.pending_parent_id': '0000000000000001',
                },
            },
            {
                'name': 'Calling tests.auto_trace_samples.foo.gen2.<locals>.inner (pending)',
                ...
                'attributes': {
                    ...
                    'code.lineno': 123,
                    'code.function': 'inner',
                    'logfire.msg_template': 'Calling tests.auto_trace_samples.foo.gen2.<locals>.inner',
                    'logfire.tags': ('testing', 'auto-tracing'),
                    'logfire.span_type': 'pending_span',
                    'logfire.msg': 'Calling tests.auto_trace_samples.foo.gen2.<locals>.inner',
                    'logfire.pending_parent_id': '0000000000000003',
                },
            },
            {
                'name': 'Calling tests.auto_trace_samples.foo.gen2.<locals>.inner',
            ...
            {
                'name': 'Calling gen2 via @instrument',
