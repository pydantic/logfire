...
""",
                    ...
                    'gen_ai.aggregated_usage.details.accepted_prediction_tokens': 0,
                    'gen_ai.aggregated_usage.details.audio_tokens': 0,
                    'gen_ai.aggregated_usage.details.reasoning_tokens': 0,
                    'gen_ai.aggregated_usage.details.rejected_prediction_tokens': 0,
                    'pydantic_ai.all_messages': [
                        {'role': 'user', 'parts': [{'type': 'text', 'content': 'tell a joke about socks'}]},
                        {
                            'role': 'assistant',
