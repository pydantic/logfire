...
async def test_responses(exporter: TestExporter):
    ...
    assert simplify_spans(exporter.exported_spans_as_dict(parse_json_attributes=True)) == snapshot(
        [
            ...
            {
                'name': 'Turn {turn} for agent agent1',
                'context': {'trace_id': 1, 'span_id': 7, 'is_remote': False},
                'parent': {'trace_id': 1, 'span_id': 5, 'is_remote': False},
                'start_time': 4000000000,
                'end_time': 11000000000,
                'attributes': {
                    ...
                    'code.lineno': 123,
                    'logfire.msg_template': 'Turn {turn} for agent agent1',
                    'logfire.span_type': 'span',
                    'type': 'custom',
            ...
            {
                'name': 'Responses API with {gen_ai.request.model!r}',
                'context': {'trace_id': 1, 'span_id': 19, 'is_remote': False},
                'parent': {'trace_id': 1, 'span_id': 17, 'is_remote': False},
            ...
            {
                'name': 'Turn {turn} for agent agent2',
                ...
                'attributes': {
                    ...
                    'type': 'custom',
                    'gen_ai.system': 'openai',
                    'logfire.msg_template': 'Turn {turn} for agent agent2',
                    'sdk_span_type': 'turn',
                    'turn': 2,
                    'agent_name': 'agent2',
        ...
        [
            ...
            },
            {
                ...
                'attributes': {
                    ...
                    'logfire.span_type': 'span',
                    'type': 'custom',
                    'logfire.msg': 'Turn 1 for agent my_agent',
                    'sdk_span_type': 'turn',
                    'turn': 1,
                    'agent_name': 'my_agent',
    ...
    assert simplify_spans(exporter.exported_spans_as_dict(parse_json_attributes=True)) == snapshot(
        [
            ...
            },
            {
                'name': 'Turn {turn} for agent agent1',
                'context': {'trace_id': 1, 'span_id': 15, 'is_remote': False},
                'parent': {'trace_id': 1, 'span_id': 13, 'is_remote': False},
...
""",
            ...
            {
                'name': 'Turn {turn} for agent agent',
                'context': {'trace_id': 1, 'span_id': 7, 'is_remote': False},
                'parent': {'trace_id': 1, 'span_id': 5, 'is_remote': False},
                'start_time': 4000000000,
                'end_time': 7000000000,
                'attributes': {
                    ...
                    'code.lineno': 123,
                    'logfire.msg_template': 'Turn {turn} for agent agent',
                    'logfire.span_type': 'span',
                    'type': 'custom',
...
async def test_function_tool_exception(exporter: TestExporter):
    ...
    assert simplify_spans(exporter.exported_spans_as_dict(parse_json_attributes=True)) == snapshot(
        [
            ...
            {
                'name': 'Turn {turn} for agent Start Agent',
                'context': {'trace_id': 1, 'span_id': 7, 'is_remote': False},
                'parent': {'trace_id': 1, 'span_id': 5, 'is_remote': False},
                'start_time': 4000000000,
                'end_time': 10000000000,
                'attributes': {
                    ...
                    'code.lineno': 123,
                    'logfire.msg_template': 'Turn {turn} for agent Start Agent',
                    'type': 'custom',
                    'name': 'turn',
                    'logfire.span_type': 'span',
                    'sdk_span_type': 'turn',
