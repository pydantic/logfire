        ...
        [
            ...
            },
            {
                ...
                'attributes': {
                    ...
                    'type': 'custom',
                    'name': 'turn',
                    'data': {'sdk_span_type': 'turn', 'turn': 1, 'agent_name': 'my_agent'},
                    'gen_ai.system': 'openai',
                    'error': {'message': 'Guardrail tripwire triggered', 'data': {'guardrail': 'zero_guardrail'}},
                    'logfire.msg': 'OpenAI agents: custom span failed: Guardrail tripwire triggered',
                },
            },
            {
                'name': 'Agent run: {name!r}',
            ...
            },
            {
                ...
                'attributes': {
                    ...
                    'type': 'custom',
                    'name': 'task',
                    'data': {'sdk_span_type': 'task', 'name': 'Agent workflow'},
                    'gen_ai.system': 'openai',
                    'logfire.msg': 'OpenAI agents: custom span',
                },
            },
