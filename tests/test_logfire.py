        ...
        [
            {
                ...
                'attributes': {
                    ...
                    'exception.logfire.data': '[{"type":"int_parsing","loc":["a"],"msg":"Input should be a valid integer, unable to parse string as an integer","input":"haha"}]',
                },
                'events': [
                    {
                        'name': 'exception',
...
""",
                            'exception.stacktrace': 'For further information visit https://errors.pydantic.dev/2.7/v/int_parsing',
