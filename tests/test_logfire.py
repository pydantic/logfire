...
def test_frame_vars(exporter: TestExporter):
    local_var1 = 21
    local_var2 = 22
    local_var3 = {'foo': 23}
    ...
    assert exporter.exported_spans_as_dict() == snapshot(
        [
            {
                'name': 'log {GLOBAL_VAR} {local_var2} {bar}',
                'context': {'trace_id': 1, 'span_id': 3, 'is_remote': False},
                'parent': {'trace_id': 1, 'span_id': 1, 'is_remote': False},
                'start_time': 2000000000,
                'end_time': 2000000000,
                'attributes': {
                    'logfire.span_type': 'log',
                    'logfire.level_num': 9,
                    'logfire.msg_template': 'log {GLOBAL_VAR} {local_var2} {bar}',
                    'logfire.msg': 'log 1 22 6',
                    'code.filepath': 'test_logfire.py',
                    ...
                    'logfire.json_schema': '{"type":"object","properties":{"foo":{},"bar":{},"GLOBAL_VAR":{},"local_var2":{}}}',
                },
            },
            {
                'name': 'log2 {local_var1} {local_var1.real}',
                'context': {'trace_id': 1, 'span_id': 4, 'is_remote': False},
                'parent': {'trace_id': 1, 'span_id': 1, 'is_remote': False},
                'start_time': 3000000000,
                'end_time': 3000000000,
                'attributes': {
                    'logfire.span_type': 'log',
                    'logfire.level_num': 9,
                    'logfire.msg_template': 'log2 {local_var1} {local_var1.real}',
                    'logfire.msg': 'log2 210 210',
                    'code.filepath': 'test_logfire.py',
                    'code.function': 'test_frame_vars',
                    'code.lineno': 123,
                    'local_var1': 210,
                    'logfire.json_schema': '{"type":"object","properties":{"local_var1":{}}}',
                },
            },
            {
                'name': 'log3 {local_var1.real} {foo.bar}',
                'context': {'trace_id': 1, 'span_id': 5, 'is_remote': False},
                'parent': {'trace_id': 1, 'span_id': 1, 'is_remote': False},
                'start_time': 4000000000,
                'end_time': 4000000000,
                'attributes': {
                    'logfire.span_type': 'log',
                    'logfire.level_num': 9,
                    'logfire.msg_template': 'log3 {local_var1.real} {foo.bar}',
                    'logfire.msg': 'log3 7 8',
                    'code.filepath': 'test_logfire.py',
                    'code.function': 'test_frame_vars',
                    'code.lineno': 123,
                    'local_var1.real': 7,
                    'foo.bar': 8,
                    'logfire.json_schema': '{"type":"object","properties":{"local_var1.real":{},"foo.bar":{}}}',
                },
            },
            {
                'name': 'log4 {local_var1.foo}',
                'context': {'trace_id': 1, 'span_id': 6, 'is_remote': False},
                'parent': {'trace_id': 1, 'span_id': 1, 'is_remote': False},
                'start_time': 5000000000,
                'end_time': 5000000000,
                'attributes': {
                    'logfire.span_type': 'log',
                    'logfire.level_num': 9,
                    'logfire.msg_template': 'log4 {local_var1.foo}',
                    'logfire.msg': 'log4 9',
                    'code.filepath': 'test_logfire.py',
                    'code.function': 'test_frame_vars',
                    'code.lineno': 123,
                    'local_var1.foo': 9,
                    'logfire.json_schema': '{"type":"object","properties":{"local_var1.foo":{}}}',
                },
            },
            {
                'name': 'log5 {local_var3[foo]}',
                ...
                'attributes': {
                    'logfire.span_type': 'log',
                    'logfire.level_num': 9,
                    'logfire.msg_template': 'log5 {local_var3[foo]}',
                    'logfire.msg': 'log5 23',
                    'code.filepath': 'test_logfire.py',
                    'code.function': 'test_frame_vars',
                    'code.lineno': 123,
                    'local_var3': IsJson(local_var3),
                    'logfire.json_schema': '{"type":"object","properties":{"local_var3":{"type":"object"}}}',
                },
            },
            {
                ...
                'attributes': {
                    ...
                    'GLOBAL_VAR': GLOBAL_VAR,
                    'local_var1': 21,
                    'logfire.msg_template': 'span {GLOBAL_VAR} {local_var1} {foo}',
                    'logfire.msg': 'span 1 21 3',
                    'logfire.json_schema': '{"type":"object","properties":{"foo":{},"bar":{},"GLOBAL_VAR":{},"local_var1":{}}}',
                    'logfire.span_type': 'span',
                },
            },
        ]
